...
class container_properties_mixin (object):
    def __init__(self, type, teu_factor, dwell_time, peak_factor, stack_occupancy, length, width, height, *args, **kwargs):
        super().__init__(*args, **kwargs)
        "initialize"
        self.type = type
...
class hasscenario_properties_mixin(object):
    ...
    def __init__(self, historic_data=[], scenario_data=[], scenario_tgs_data=[], *args, **kwargs):
        super().__init__(*args, **kwargs)
        """Initialization"""
...
class yard_properties_mixin(object):
    def __init__(self, coords=[], terminal=[], prim_yard=[], apron=[], terminal_area=[], prim_yard_area=[], apron_area=[], prim_full_ratio=[], stack_equipment=[], quay_length=[], apron_width=[],
                 stack=[], current_origin=[], block_list=[], block_location_list=[], max_blocks_x=[], max_blocks_y=[], land_price=[], laden_perc=[], reefer_perc=[], *args, **kwargs):
        super().__init__(*args, **kwargs)
        "Initialization"
        self.coords = coords
